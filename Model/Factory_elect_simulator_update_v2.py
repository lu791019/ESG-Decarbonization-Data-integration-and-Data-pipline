...
def factory_elct_main_fn():
    ...
    data_upload_final_Y23base_final_bymonth_bysite = data_upload_final_Y23base_final_bymonth_bysite.loc[data_upload_final_Y23base_final_bymonth_bysite.year<str(base_year+3)].append(end_year_predict_all).reset_index(drop=True)
